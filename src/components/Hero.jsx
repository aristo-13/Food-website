...
function Hero() {
  return (
    <div className="w-full p-4">
       <div className="max-h-[500px] relative rounded overflow-hidden">
          <div className=" bg-black/60 absolute w-full text-gray-200 bottom-0 h-full flex flex-col justify-center">
